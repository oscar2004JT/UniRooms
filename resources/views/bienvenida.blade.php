    ...
    <div class="max-w-7xl mx-auto px-4">
      <div class="flex items-center justify-between h-20">
        ...
        <nav class="flex items-center gap-3">
          <button class="ml-2 inline-block bg-transparent border border-white/60 text-white font-medium rounded-md px-4 py-2 hover:bg-white/10 transition" id="btn-register">Registrarse</button>
          <button class="ml-2 inline-block bg-transparent border border-white/60 text-white font-medium rounded-md px-4 py-2 hover:bg-white/10 transition" id="btn-login">Iniciar Sesión</button>
    ...
    <section class="hero-section text-center py-20 bg-gradient-to-r from-blue-900 to-blue-600 text-white">
      <div class="max-w-4xl mx-auto px-4">
        ...
        <div class="hero-buttons flex flex-wrap justify-center gap-4">
          ...
          <button id="btn-publish-room" class="btn btn-outline btn-lg text-white border-white/60 font-semibold px-6 py-3 rounded-lg inline-flex items-center gap-2">
            <i data-lucide="plus-circle" class="inline"></i>
            Publicar Habitación
          </button>
        </div>
      </div>
