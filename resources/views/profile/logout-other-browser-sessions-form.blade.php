<x-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Si lo consideras necesario, puedes cerrar sesión en todos los demás navegadores y dispositivos en los que hayas iniciado sesión. Algunas de tus sesiones recientes se muestran a continuación; sin embargo, esta lista puede no ser exhaustiva. Si sospechas que tu cuenta ha sido comprometida, también deberías cambiar tu contraseña.') }}
        </div>
        ...
        <x-dialog-modal wire:model.live="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Por favor, ingresa tu contraseña para confirmar que deseas cerrar las sesiones activas en otros navegadores y dispositivos.') }}
